...
reg [`WIN*8-1:0] slave_tdata_1r1c_wide;
reg slave_tvalid_1r1c_wide;
wire slave_tready_1r1c_wide;
wire [`WOUT*8-1:0] master_tdata_1r1c_wide;
wire master_tvalid_1r1c_wide;
reg master_tready_1r1c_wide;

wide_axi_stream_wrappered_1r1c_idct idct_1r1c_wide(master_tdata_1r1c_wide, master_tvalid_1r1c_wide, 1'b1 /*master_tready_1r1c_wide*/,
                                                   slave_tdata_1r1c_wide, slave_tvalid_1r1c_wide, slave_tready_1r1c_wide, clock, reset);

wire finish;

checker checker_1r1c(clock, master_tdata_1r1c_wide, master_tvalid_1r1c_wide, finish);
...
initial begin
  ...
  reset <= 0;
  clock <= 0;
  slave_tdata_1r1c_wide <= 0;
  slave_tvalid_1r1c_wide <= 0;
  clock <= 0;
  #5;
  clock <= 1;
  #5;
